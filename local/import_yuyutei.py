...
使用方法:
  python import_yuyutei.py --input /home/ubuntu/project/data/yuyutei_20260128.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="遊々亭データインポート")
    ...
    if not shop:
        ...
        print("先にshopsテーブルに遊々亭を追加してください")
        return
